    ...
    return (
        <div className="p-5 shadow text-left flex flex-col">
            <div className="pt-1 font-normal">
                <input disabled={disable} placeholder={t('address')} value={destinationAddress}
            ...
            <div className="pt-4">
                <button style={{float: 'right'}} disabled={disable} id="GetBalanceButton" name="GetBalanceButton"
